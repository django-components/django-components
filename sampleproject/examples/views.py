                    ...
                    {% else %}
                        <div class="text-center py-12">
                            ...
                            <p class="text-gray-600">
                                No example components were discovered in the docs_site/examples/ directory.
                            </p>
                        </div>
                    {% endif %}
                    ...
                    <div class="mt-12 text-center">
                        <div class="bg-white rounded-lg shadow-sm p-6">
                            ...
                            <p class="text-gray-600 mb-4">
                                These examples are dynamically discovered from the <code class="bg-gray-100 px-2 py-1 rounded text-sm">docs_site/examples/</code> directory.
