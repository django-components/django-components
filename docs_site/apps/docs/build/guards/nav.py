...
GENERATED_NAV_URLS = {
    ...
    # Generated by build/reference.py (Phase 4); content stubs removed.
    "docs/reference/exceptions",
    "docs/reference/api",
    "docs/reference/commands",
    "docs/reference/components",
    "docs/reference/extension_commands",
    "docs/reference/extension_hooks",
    "docs/reference/extension_urls",
    "docs/reference/settings",
    "docs/reference/signals",
    "docs/reference/tag_formatters",
    "docs/reference/template_tags",
    "docs/reference/template_variables",
    "docs/reference/testing_api",
    "docs/reference/urls",
}
