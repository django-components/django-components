---
title: Commands
description: API reference - Commands.
---
...
!!! info "This page is being rebuilt"
    ...
    use the [Commands reference on the current docs site](https://django-components.github.io/django-components/latest/reference/commands/).
