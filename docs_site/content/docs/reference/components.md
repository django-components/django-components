---
title: Components
description: API reference - Components.
---
...
!!! info "This page is being rebuilt"
    ...
    use the [Components reference on the current docs site](https://django-components.github.io/django-components/latest/reference/components/).
